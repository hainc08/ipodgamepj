...
#import "AlarmGitaiFinalAppDelegate.h"
...
- (void)dealloc {
	[[ImgManager getInstance] closeManager];
	[[DateFormat getInstance] closeManager];
	[[AlarmConfig getInstance] closeManager];

...
- (void)viewDidLoad {
	...
	DisplayOption = [[ButtonView alloc] initWithFrame:CGRectMake(300, 40,  BUTTON_X, BUTTON_Y)];
	[DisplayOption setView:2  fontsize:12 fontColor:[UIColor whiteColor]  setText:@"DISPLAY OPTION" bgColor:[UIColor clearColor] chekImage:FALSE];
	...
	AlarmOption = [[ButtonView alloc] initWithFrame:CGRectMake(300, 140,  BUTTON_X, BUTTON_Y)];
	[AlarmOption setView:2  fontsize:12 fontColor:[UIColor whiteColor]  setText:@"ALARM OPTION" bgColor:[UIColor clearColor] chekImage:FALSE];
	...
	Done = [[ButtonView alloc] initWithFrame:CGRectMake(300, 240,  BUTTON_X, BUTTON_Y)];

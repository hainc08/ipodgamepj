...
- (void)viewDidLoad {
	...
	[HourMode setView:1  fontsize:12 fontColor:[UIColor whiteColor]  setText:@"HOUR MODE" bgColor:[UIColor clearColor] chekImage:[[AlarmConfig getInstance] getHourMode]];
	...
	[self HourModeButton:nil];
	
	DisplayDate = [[ButtonView alloc] initWithFrame:[self ButtonPlace:2	y:3]];
	[DisplayDate setView:1  fontsize:12 fontColor:[UIColor whiteColor]  setText:@"DISPLAY DATE" bgColor:[UIColor clearColor] chekImage:[[AlarmConfig getInstance] getDateDisplay]];
	...
	[WeekDisplay setView:1  fontsize:12 fontColor:[UIColor whiteColor]  setText:@"SHOW Weekday" bgColor:[UIColor clearColor] chekImage:[[AlarmConfig getInstance] getWeekDisplay]];
	...
	[Done setView:2  fontsize:12 fontColor:[UIColor whiteColor]  setText:@"DONE" bgColor:[UIColor clearColor] chekImage:FALSE];
...
{
	[HourMode setCheck:true];
	if ([[AlarmConfig getInstance] setHourMode])
		[HourMode setCheckImg:@"24hr.png"];
	else
		[HourMode setCheckImg:@"12hr.png"];
